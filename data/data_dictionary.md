...
second Progressive product within 12 months.
...
| `state` | string | State where household is located | Geographic segmentation; agent density and property rates vary significantly by state | 10 states weighted by Progressive market presence |
...
| `anchor_product` | string | First (existing) Progressive product the household holds | Auto is dominant; Motorcycle and Boat represent niche segments with different property needs | Four products: Auto, Motorcycle, Boat, Commercial Auto |
...
| `tenure_months` | integer | Months since household's first policy with Progressive | Established customers (24+ months) show stronger trust and conversion; very new customers (under 6 months) convert poorly | Range: 1-120 |
...
- **1** = The household added a second Progressive product (property, renters, condo, umbrella)
